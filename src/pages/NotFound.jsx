...
const NotFound = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 px-4">
      <p className="text-8xl font-extrabold text-gray-200 dark:text-gray-700 select-none">404</p>
      <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-4">Page not found</h1>
